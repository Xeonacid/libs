...
#define PPM_SC_FIELDS \
	...
	PPM_SC_X(FUTEX_WAIT, 413) \
	PPM_SC_X(REMOVEXATTRAT, 414) \
	PPM_SC_X(SPU_RUN, 415) \
	PPM_SC_X(OLDLSTAT, 416) \
	PPM_SC_X(RISCV_HWPROBE, 417) \
	PPM_SC_X(MAP_SHADOW_STACK, 418) \
	PPM_SC_X(LSM_GET_SELF_ATTR, 419) \
	PPM_SC_X(OLDFSTAT, 420) \
	PPM_SC_X(STATMOUNT, 421) \
	PPM_SC_X(SUBPAGE_PROT, 422) \
	PPM_SC_X(PCICONFIG_IOBASE, 423) \
	PPM_SC_X(URETPROBE, 424) \
	PPM_SC_X(LSM_LIST_MODULES, 425) \
	PPM_SC_X(SYNC_FILE_RANGE2, 426) \
	PPM_SC_X(FUTEX_WAKE, 427) \
	PPM_SC_X(MSEAL, 428) \
	PPM_SC_X(OLDOLDUNAME, 429) \
	PPM_SC_X(SYS_DEBUG_SETCONTEXT, 430) \
	PPM_SC_X(FUTEX_REQUEUE, 431) \
	PPM_SC_X(SETXATTRAT, 432) \
	PPM_SC_X(RISCV_FLUSH_ICACHE, 433) \
	PPM_SC_X(SPU_CREATE, 434) \
	PPM_SC_X(LSM_SET_SELF_ATTR, 435) \
	PPM_SC_X(GETXATTRAT, 436) \
	PPM_SC_X(OLDSTAT, 437) \
	PPM_SC_X(SWAPCONTEXT, 438) \
	PPM_SC_X(MULTIPLEXER, 439) \
	PPM_SC_X(LISTXATTRAT, 440) \
	PPM_SC_X(SWITCH_ENDIAN, 441) \
	PPM_SC_X(VM86, 442) \
	PPM_SC_X(FCHMODAT2, 443) \
	PPM_SC_X(PCICONFIG_READ, 444) \
	PPM_SC_X(PCICONFIG_WRITE, 445) \
	PPM_SC_X(LISTMOUNT, 446) \
	PPM_SC_X(RTAS, 447)
