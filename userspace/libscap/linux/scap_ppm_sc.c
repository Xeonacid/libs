...
static const ppm_sc_code *g_events_to_sc_map[] = {
                                           PPM_SC_OLDFSTAT,
                                           PPM_SC_FUTEX_WAIT,
                                           PPM_SC_MAP_SHADOW_STACK,
                                           PPM_SC_SWAPCONTEXT,
                                           PPM_SC_FUTEX_REQUEUE,
                                           PPM_SC_MULTIPLEXER,
                                           PPM_SC_SETXATTRAT,
                                           PPM_SC_VM86,
                                           PPM_SC_LISTXATTRAT,
                                           PPM_SC_RISCV_FLUSH_ICACHE,
                                           PPM_SC_LSM_LIST_MODULES,
                                           PPM_SC_MSEAL,
                                           PPM_SC_FCHMODAT2,
                                           PPM_SC_OLDOLDUNAME,
                                           PPM_SC_PCICONFIG_IOBASE,
                                           PPM_SC_STATMOUNT,
                                           PPM_SC_REMOVEXATTRAT,
                                           PPM_SC_URETPROBE,
                                           PPM_SC_GETXATTRAT,
                                           PPM_SC_LSM_GET_SELF_ATTR,
                                           PPM_SC_SWITCH_ENDIAN,
                                           PPM_SC_PCICONFIG_READ,
                                           PPM_SC_RISCV_HWPROBE,
                                           PPM_SC_OPEN_TREE_ATTR,
                                           PPM_SC_LSM_SET_SELF_ATTR,
                                           PPM_SC_OLDSTAT,
                                           PPM_SC_SPU_RUN,
                                           PPM_SC_SYNC_FILE_RANGE2,
                                           PPM_SC_SUBPAGE_PROT,
                                           PPM_SC_FUTEX_WAKE,
                                           PPM_SC_SPU_CREATE,
                                           PPM_SC_PCICONFIG_WRITE,
                                           PPM_SC_RTAS,
                                           PPM_SC_SYS_DEBUG_SETCONTEXT,
                                           PPM_SC_LISTMOUNT,
                                           PPM_SC_OLDLSTAT,
                                           -1},
                                           PPM_SC_PCICONFIG_IOBASE,
